...
//		alumno = new Persona();
		...
		AccionesAlumnoImpl accionesAlumnoImpl = new AccionesAlumnoImpl();
		accionesAlumnoImpl.estudiar();
		System.out.println(accionesAlumnoImpl.obtenerNota());
		System.out.println(accionesAlumnoImpl.obtenerNombre());
		System.out.println(accionesAlumnoImpl.obtenerNombre("1111111"));
		accionesAlumnoImpl.reprueba();
