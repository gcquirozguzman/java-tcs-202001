...
public class TipoDatosEnteros {

	public static void main(String[] args) {
		
		// Tipo de Datos Enteros (long int short byte)
		...
		int primeraVariable, segundaVariable, terceraVariable;
		int cuartaVariable = 12, sextaVariable = 99;
